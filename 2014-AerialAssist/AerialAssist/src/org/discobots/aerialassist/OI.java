...
// Controller 1
        ...
        b_btnB.whenPressed(new FireLauncher(FireLauncher.FIRE, 1));
        b_btnA.whenPressed(new FireLauncher(FireLauncher.FIRE, 3));
...
// Controller 2
        ...
        b2_trigR.whenPressed(new FireLauncher(FireLauncher.FIRE, 3));//These are Seth's controls.  They will eventually be moved to the second controller.
