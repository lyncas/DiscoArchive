...
public class Robot implements drawable {
	...
	double centerX = origin.getX() + pose.getX() * v.X_PixelsPerUnit();
	double centerY = origin.getY() - pose.getY() * v.Y_PixelsPerUnit();
	...
	//Scale
	robotTrans.scale(v.X_PixelsPerUnit(), v.Y_PixelsPerUnit());
