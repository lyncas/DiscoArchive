...
public class PIDTune extends CommandBase {
    ...
    private PIDTuneable[] c;
    private String name;
    private double P = 0, I = 0, D = 0, F = 0;
    private double inc = 0.001;
    private GamePad gp;
    private int x10 = 0, div10 = 0;


    /*
     * Tune a set of PIDControllers to use the same values.
     */
    public PIDTune(PIDTuneable[] control, String name) {
	c = control;
	this.name = name;
	...
	SmartDashboard.putString("P", strRound6(c[0].getP()));
	SmartDashboard.putString("I", strRound6(c[0].getI()));
	SmartDashboard.putString("D", strRound6(c[0].getD()));
	SmartDashboard.putString("F", strRound6(c[0].getF()));
